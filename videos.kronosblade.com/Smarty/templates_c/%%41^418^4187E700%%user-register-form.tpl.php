<?php /* Smarty version 2.6.30, created on 2017-08-04 07:26:58
...
/include/securimage_show.php?sid=' + Math.random(); return false">
    ...
    <div class="control-group">
      ...
      <input type="checkbox" class="checkbox" id="agree" name="agree" <?php if ($this->_tpl_vars['inputs']['agree'] == 'on'): ?>checked="checked"<?php endif; ?>> <span class="help-inline"><?php echo $this->_tpl_vars['lang']['i_agree_with']; ?>
 <a data-toggle="modal" href="#terms" id="element" ><?php echo $this->_tpl_vars['lang']['terms_of_agreement']; ?>
</a></span>
      </label>
      </div>
    </div>
