<?php /* Smarty version 2.6.30, created on 2017-08-04 07:26:57
...
unset($_smarty_tpl_vars);
 ?>
			...
			<?php elseif ($this->_tpl_vars['display_form'] == 'twitter'): ?>
				...
				<hr />
				<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'user-twitter-form.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			<?php else: ?>
