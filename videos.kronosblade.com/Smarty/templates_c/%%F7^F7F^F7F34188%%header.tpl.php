<?php /* Smarty version 2.6.30, created on 2017-08-04 07:46:07
         compiled from header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'header.tpl', 76, false),array('modifier', 'escape', 'header.tpl', 93, false),array('function', 'dropdown_menu_video_categories', 'header.tpl', 385, false),array('function', 'dropdown_menu_article_categories', 'header.tpl', 393, false),)), $this); ?>
<?php $this->_cache_serials['C:\wamp\phpmelody.dev/Smarty/templates_c\%%F7^F7F^F7F34188%%header.tpl.inc'] = 'efc4f670af7b163eb410f8ecc886d525'; ?>﻿<!DOCTYPE html>
<!--[if IE 7 | IE 8]>
...
window.mmswitch_options = {
		"message":"'; ?>
<?php echo ((is_array($_tmp=@$this->_tpl_vars['lang']['mmswitch_message'])) ? $this->_run_mod_handler('default', true, $_tmp, 'Would you like to see the mobile optimized version of this page?') : smarty_modifier_default($_tmp, 'Would you like to see the mobile optimized version of this page?')); ?>
<?php echo '",
		"confirm":"'; ?>
<?php echo ((is_array($_tmp=@$this->_tpl_vars['lang']['_yes'])) ? $this->_run_mod_handler('default', true, $_tmp, 'Yes') : smarty_modifier_default($_tmp, 'Yes')); ?>
<?php echo '",
		"dismiss":"'; ?>
<?php echo ((is_array($_tmp=@$this->_tpl_vars['lang']['_no'])) ? $this->_run_mod_handler('default', true, $_tmp, 'No') : smarty_modifier_default($_tmp, 'No')); ?>
<?php echo '",
		"link":"'; ?>
<?php echo $this->_tpl_vars['_footer_switch_ui_link']; ?>
<?php echo '",
		"theme":"mobileswitch"};
</script>
'; ?>

<script type="text/javascript" src="<?php echo @_URL_MOBI; ?>
/js/mobileswitch.js"></script>
<?php endif; ?>
...
/category.php<?php else: ?>#<?php endif; ?>" class="dropdown-toggle wide-nav-link disabled" data-target="#" role="button" data-toggle="dropdown"><?php echo $this->_tpl_vars['lang']['category']; ?>
 ...
 <b class="caret"></b></a>
						<ul class="dropdown-menu">
						<?php if ($this->caching && !$this->_cache_including): echo '{nocache:efc4f670af7b163eb410f8ecc886d525#0}'; endif;echo smarty_art_html_list_categories(array('max_levels' => 3), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:efc4f670af7b163eb410f8ecc886d525#0}'; endif;?>
