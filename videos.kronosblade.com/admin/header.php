...
if ($showm == '2')
{
	...
	{
		$_COOKIE['aa_videos_per_page'] = 25;
		setcookie('aa_videos_per_page', 25, time()+(COOKIE_TIME * 100), COOKIE_PATH);
	}
	else
	{
		$_COOKIE['aa_videos_per_page'] = (int) $_COOKIE['aa_videos_per_page'];
	}
...
if ($showm == '5')
{
	...
	{
		$_COOKIE['aa_comments_per_page'] = 25;
		setcookie('aa_comments_per_page', 25, time()+(COOKIE_TIME * 100), COOKIE_PATH);
	}
	else
	{
		$_COOKIE['aa_comments_per_page'] = (int) $_COOKIE['aa_comments_per_page'];
	}
...
if ($showm == '6')
{
	...
	{
		$_COOKIE['aa_users_per_page'] = 25;
		setcookie('aa_users_per_page', 25, time()+(COOKIE_TIME * 100), COOKIE_PATH);
	}
	else
	{
		$_COOKIE['aa_users_per_page'] = (int) $_COOKIE['aa_users_per_page'];
	}
...
if ($showm == 'mod_pages')
{
	...
	{
		$_COOKIE['aa_pages_per_page'] = 25;
		setcookie('aa_pages_per_page', 25, time()+(COOKIE_TIME * 100), COOKIE_PATH);
	}
	else
	{
		$_COOKIE['aa_pages_per_page'] = (int) $_COOKIE['aa_pages_per_page'];
	}
...
if ($showm == 'mod_article')
{
	...
	{
		$_COOKIE['aa_articles_per_page'] = 25;
		setcookie('aa_articles_per_page', 25, time()+(COOKIE_TIME * 100), COOKIE_PATH);
	}
	else
	{
		$_COOKIE['aa_articles_per_page'] = (int) $_COOKIE['aa_articles_per_page'];
	}
...
if ($showm == 'cron')
{
	...
	{
		$_COOKIE['aa_cron_jobs_per_page'] = 25;
		setcookie('aa_cron_jobs_per_page', 25, time()+(COOKIE_TIME * 100), COOKIE_PATH);
	}
	else
	{
		$_COOKIE['aa_cron_jobs_per_page'] = (int) $_COOKIE['aa_cron_jobs_per_page'];
	}
