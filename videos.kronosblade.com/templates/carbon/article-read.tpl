        ...
        <div class="widget">
            ...
            {foreach from=$related_articles item=related key=id}
                <li>
                    ...
                    <h6 dir="ltr" class="ellipsis"><a href="{$related.link}" class="pm-title-link">{smarty_fewchars s=$related.title length=100}</a></h6>
                    <p class="pm-article-preview">
                    {if $related.meta.post_thumb_show == ''}
                        <div class="minDesc">{smarty_fewchars s=$related.excerpt length=225}</div>
                    {else}
                        <div class="minDesc">{smarty_fewchars s=$related.excerpt length=225}</div>
                    {/if}
                    </p>
