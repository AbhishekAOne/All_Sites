...
<nav class="wide-nav">
    <div class="row-fluid fixed960">
                ...
                <div class="container">
                  ...
                  <div class="nav-collapse">
                    <ul class="nav">
                      ...
                      <li class="dropdown">
                        <a href="{if $smarty.const.USER_DEVICE != 'mobile'}{$smarty.const._URL}/{if $smarty.const._SEOMOD}browse.{$smarty.const._FEXT}{else}category.php{/if}{else}#{/if}" class="dropdown-toggle disabled" role="button" data-target="#" data-toggle="dropdown">{$lang.category} <b class="caret"></b></a>
       ...
       <span class="span3 pm-search">
        {if $p == "article"}
        <form action="{$smarty.const._URL}/article.php" method="get" id="search" name="search" onSubmit="return validateSearch('true');">
        <div class="controls">
          <div class="input-append">
            <input class="input-medium" id="appendedInputButton" size="16" name="keywords" type="text" placeholder="{$lang.submit_search}" x-webkit-speech speech onwebkitspeechchange="this.form.submit();"><button class="btn btn-yellow" type="submit"><i class="icon-search"></i></button>
          </div>
        </div>
        </form>
        {else}
        ...
        <div class="controls">
          <div class="input-append">
            <input class="input-medium" id="appendedInputButton" size="16" name="keywords" type="text" placeholder="{$lang.submit_search}" x-webkit-speech="x-webkit-speech" onwebkitspeechchange="this.form.submit();" {if $smarty.const._SEARCHSUGGEST == 1}onblur="fill();" autocomplete="off"{/if}>
            <input id="pm-video-id" size="16" name="video-id" type="hidden">
            <button class="btn btn-yellow" type="submit"><i class="icon-search"></i></button>
          </div>
