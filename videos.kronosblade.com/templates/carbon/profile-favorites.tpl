...
<div id="wrapper">
    ...
    {if $logged_in == '1'}
      ...
      <div class="row-fluid">
        <div class="span12 extra-space well">
		<div id="primary">
        ...
        <div class="span12">
                      ...
                      <li id="favorite-{$smarty.foreach.favorite_foreach.iteration}">
                        <div class="pm-li-video">
                            ...
                            <div class="pm-video-attr">
                                ...
                                <span class="pm-video-attr-numbers">{$video_data.views_compact} {$lang.views} / {$video_data.likes_compact} {$lang._likes}</small></span>
                            </div>
            ...
            {if $share_link != ''}
            <h4>{$lang.myfavorites_share}</h4> 
            <div class="alert alert-well well-dark">
            <div class="row-fluid">
