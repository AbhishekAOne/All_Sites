  ...
  <div class="container-fluid">
    ...
    <div id="primary" class="extra-space">
        <div class="tab-content">
          	<div class="tab-pane{if $display_form == 'register' || $display_form == 'twitter'} active{/if} well" id="pm-register">
		    {if $display_form == 'register'}
				{if $success}
            ...
            <div class="tab-pane{if $display_form == 'login'} active{/if} well" id="pm-login">
            <h1>{$lang.login}</h1>
            <hr />
            ...
            <div class="tab-pane{if $display_form == 'forgot_pass'} active{/if} well" id="pm-reset">
            ...
            <div class="tab-pane{if $display_form == 'activate_acc'} active{/if} well" id="pm-reset">
            ...
            <div class="tab-pane{if $display_form == 'pwdreset'} active{/if} well" id="pm-reset">
