...
<h1 class="entry-title">{$video_data.video_title}</h1>
	<div class="span12 pm-video-pane border-radius5">
	<div id="pm-video-left">
		...
		<div class="row-fluid">
			...
			{if $video_data.featured == 1}
				<span class="pm-label-featured">{$lang.featured}</span>
			{/if}
			</div>
			<div class="span6">
	...
	<div class="clearfix"></div>
			...
			<a href="{$smarty.const._URL}/{$smarty.const._ADMIN_FOLDER}/modify.php?vid={$video_data.uniq_id}" rel="tooltip" class="btn btn-small pull-right" title="{$lang.edit} ({$lang._admin_only})" target="_blank">{$lang.edit}</a>
		...
		<div id="bin-rating-response" class="hide well-dark well-small"></div>
		<div id="bin-rating-like-confirmation" class="hide well-dark well-small alert alert-well">
  ...
  src="{$smarty.const._URL}/templates/{$template_dir}/img/gplus-round.png" alt=""></a>
		...
		<div id="bin-rating-dislike-confirmation" class="hide-dislike hide well-dark well-small">
		<button type="button" class="close" data-dismiss="alert">&times;</button>
		...
		<div id="pm-vc-report-content" class="hide well-dark well-small alert alert-well">
		...
		<div id="pm-vc-share-content" class="well-dark alert alert-well">
			<div class="row-fluid">
  ...
  src="{$smarty.const._URL}/templates/{$template_dir}/img/gplus-round.png" alt="" /></a>  
			...
			<div id="pm-vc-email-content">
			  <hr />
		<div id="share-confirmation" class="hide well-dark well-small"></div>
