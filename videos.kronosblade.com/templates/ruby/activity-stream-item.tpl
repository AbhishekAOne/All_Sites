<li class="pm-li-activity" id="activity-{$activity_meta.activity_id}">
	...
	{if $s_user_id == $actor_bucket.$activity_index.0.user_id}
		<a href="#" class="pull-right pm-li-activity-hide opac7" id="hide-activity-{$activity_meta.activity_id}" rel="tooltip" title="{$lang.hide_from_stream}"><i class="icon-remove icon-white"></i> </a>
	{/if}
    </div>
