...
<div id="wrapper" class="profile-page no-bg">
            ...
            {foreach from=$submitted_video_list key=k item=video_data}
              <li>
                <div class="pm-li-video{if $video_data.pending_approval} pending{/if}">
                    ...
                    <a href="{$video_data.video_href}" class="pm-thumb-fix pm-thumb-194"><span class="pm-thumb-fix-clip"><img src="{$video_data.thumb_img_url}" alt="{$video_data.video_title}" width="194"><span class="vertical-align"></span></span></a>
