...
<script src="{/literal}{$smarty.const._URL}/templates/{$template_dir}{literal}/js/melody.dev.js?v2" type="text/javascript"></script>
...
$(document).ready(function() {
	$("#pm-ul-home-articles").carouFredSel({
	items: 3,
	direction: "up",
		height				: "variable",
		width       		: "variable",
	...
	auto: false,
		prev	: {	
			button	: "#pm-slide-art-prev",
			key		: "left"
		},
		next	: { 
			button	: "#pm-slide-art-next",
			key		: "right"
		}
	});	
});
