...
<div class="row-fluid fixed960">
    ...
    <div id="user-pane" class="border-radius4">
        ...
        {if $allow_registration == '1'}
            ...
            <a class="primary ajax-modal" data-toggle="modal" data-backdrop="true" data-keyboard="true" href="#header-register-form"><img src="{$smarty.const._URL}/templates/{$template_dir}/img/pm-avatar.png" width="40" height="40" alt=""></a>
            {else}
            <a href="{$smarty.const._URL}/register.{$smarty.const._FEXT}"><img src="{$smarty.const._URL}/templates/{$template_dir}/img/pm-avatar.png" width="40" height="40" alt=""></a>
            {/if}
        
        {else}
        <img src="{$smarty.const._URL}/templates/{$template_dir}/img/pm-avatar.png" width="40" height="40" alt="">
        {/if}
        <span class="greet-links">
        <div class="ellipsis"><strong>{$lang._welcome}</strong></div>
        <span class="avatar-img"><a class="primary ajax-modal" data-toggle="modal" data-backdrop="true" data-keyboard="true" href="#header-login-form">{$lang.login}</a> 
        ...
        {/if}
        <a href="#" id="notification_counter" title="Notifications"><img src="{$s_avatar_url}" width="40" height="40" alt=""></a>
        </span>
        
        <span class="greet-links">
        <div class="ellipsis"><strong><a href="{$current_user_data.profile_url}">{$s_name}</a></strong></div>
        {if $smarty.const._ALLOW_USER_SUGGESTVIDEO == '1'}<a href="{$smarty.const._URL}/suggest.{$smarty.const._FEXT}">{$lang.suggest}</a>{/if} {if $smarty.const._ALLOW_USER_UPLOADVIDEO == '1'}/ <a href="{$smarty.const._URL}/upload.{$smarty.const._FEXT}">{$lang.upload}</a>{/if}
        </span>
        </div>
        ...
        {if $smarty.const._MOD_SOCIAL && $logged_in}<!--//$notification_count > 0}-->
            <div class="hide" id="notification_temporary_display_container" class="top"></div>
        {/if}
                ...
                <div class="container">
                  ...
                  <div class="nav-collapse">
                    <ul class="nav">
                      ...
                      <li class="dropdown">
                        <a href="{if $smarty.const.USER_DEVICE != 'mobile'}{if $smarty.const.USER_DEVICE != 'mobile'}{$smarty.const._URL}/{if $smarty.const._SEOMOD}browse.{$smarty.const._FEXT}{else}category.php{/if}{else}#{/if}{else}#{/if}" class="dropdown-toggle disabled" role="button" data-target="#" data-toggle="dropdown">{$lang.category} <b class="caret"></b></a>
                      ...
                      <li><a href="{$smarty.const._URL}/topvideos.{$smarty.const._FEXT}">{$lang._popular}</a></li>
       ...
       <div class="pm-search">
        ...
        <div class="controls">
          <div class="input-append">
            <input class="input-medium inp-small" id="appendedInputButton" size="16" name="keywords" type="text" placeholder="{$lang.submit_search}" x-webkit-speech speech onwebkitspeechchange="this.form.submit();"><button class="btn btn-blue" type="submit"><i class="icon-search"></i></button>
          </div>
        </div>
        </form>
        {else}
        ...
        <div class="controls">
          <div class="input-append">
            <input class="input-medium inp-small" id="appendedInputButton" size="16" name="keywords" type="text" placeholder="{$lang.submit_search}" x-webkit-speech="x-webkit-speech" onwebkitspeechchange="this.form.submit();" {if $smarty.const._SEARCHSUGGEST == 1}onblur="fill();" autocomplete="off"{/if}>
