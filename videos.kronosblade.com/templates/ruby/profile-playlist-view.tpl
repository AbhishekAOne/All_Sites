      ...
      <div class="row-fluid">
		...
		<div class="modal hide" id="playlist-share" role="dialog" aria-labelledby="playlist-share-form-label">
		    ...
		    <div class="modal-body">
				...
				<div class="row-fluid">
		            <div class="span8">
		            <div class="input-prepend"><span class="add-on">URL</span><input name="video_link" id="video_link" type="text" value="{$share_link}" class="span10" onClick="SelectAll('video_link');"></div>
		            </div>
		            <div class="span4">
		            <a href="https://www.facebook.com/sharer.php?u={$share_link_urlencoded}&amp;t={$share_title_urlencoded}" onclick="javascript:window.open(this.href,
		'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" rel="tooltip" title="Share on FaceBook"><img src="{$smarty.const._URL}/templates/{$template_dir}/img/facebook-round.png"></a>
		            <a href="https://twitter.com/home?status=Watching%20{$share_title_urlencoded}%20on%20{$share_link_urlencoded}" onclick="javascript:window.open(this.href,
		'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" rel="tooltip" title="Share on Twitter"><img src="{$smarty.const._URL}/templates/{$template_dir}/img/twitter-round.png"></a>
					<a href="https://plus.google.com/share?url={$share_link_urlencoded}" onclick="javascript:window.open(this.href,
