...
<div id="wrapper">
    <div class="container-fluid">
      <div class="row-fluid">
		...
		{$lang.sorting}: 
		<select name="categories" size="1" class="inp-small" onChange="javascript:document.location=this.value;">
		...
		{foreach from=$results key=k item=video_data name=loop}
		  <li>
			<div class="pm-li-video">
			    <span class="pm-video-thumb pm-thumb-185 pm-thumb border-radius2">
			    ...
			    <a href="{$video_data.video_href}" class="pm-thumb-fix pm-thumb-185"><span class="pm-thumb-fix-clip"><img src="{$video_data.thumb_img_url}" alt="{$video_data.attr_alt}" width="194"><span class="vertical-align"></span></span></a>
			    </span>
			    ...
			    <div class="pm-video-attr">
			        ...
			        <span class="pm-video-attr-since">{$lang.added} <time datetime="{$video_data.html5_datetime}"  title="{$video_data.full_datetime}">{$video_data.time_since_added} {$lang.ago}</time></small></span>
