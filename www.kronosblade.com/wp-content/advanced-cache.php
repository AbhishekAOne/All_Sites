...
$rocket_cache_path  = '/home1/kronosb1/public_html/wp-content/cache/wp-rocket/';
$rocket_config_path = '/home1/kronosb1/public_html/wp-content/wp-rocket-config/';

if ( file_exists( '/home1/kronosb1/public_html/wp-content/plugins/wp-rocket/inc/front/process.php' ) && version_compare( phpversion(), '5.4' ) >= 0 ) {

	spl_autoload_register( function( $class ) {
		$rocket_path    = '/home1/kronosb1/public_html/wp-content/plugins/wp-rocket/';
		$rocket_classes = [
	...
	include '/home1/kronosb1/public_html/wp-content/plugins/wp-rocket/inc/front/process.php';
} else {
