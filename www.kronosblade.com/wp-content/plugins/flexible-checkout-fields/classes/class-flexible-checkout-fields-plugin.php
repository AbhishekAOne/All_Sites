 ...
 */
class Flexible_Checkout_Fields_Plugin extends \WPDesk\PluginBuilder\Plugin\AbstractPlugin {
	 ...
	 * @var string
	 */
	private $scripts_version = FLEXIBLE_CHECKOUT_FIELDS_VERSION . '-4';
