...
<div style="width: 90%; padding: 10px; margin: 10px;">
 <div style="width: 100%;background-color: #a46497; border: 1px solid #a46497; border-radius: 13px; padding: 20px;"><h1><span style="color: white;">Woo Shortcodes Kit v 1.8.<small>0</small></span><span style="font-size: 12px; color: #c6adc2; float: right;margin-top: 35px;"><?php  echo get_num_queries(); ?> <?php esc_html_e( 'Queries in', 'woo-shortcodes-kit' ); ?> <?php timer_stop(1); ?>  <?php esc_html_e( 'seconds', 'woo-shortcodes-kit' ); ?>
 </span></h1>
...
<br><br>
    ...
    <br /><br /><table>
    <tr>    
    <td style="padding: 30px; width: 35%;"><h4 style="margin-top: -55px;"><span class="dashicons dashicons-admin-users"></span> <?php esc_html_e( 'Customize the avatar', 'woo-shortcodes-kit' ); ?></h4>
