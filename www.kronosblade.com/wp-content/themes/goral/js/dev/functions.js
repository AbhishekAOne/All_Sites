        ...
        $('[data-load="ajax"] a').click(function(){
            ...
            if ( main.length > 0 && main.data('loaded') == false ) {
                ...
                $.ajax({
                    ...
                    type:'POST',
                    dataType: 'html',
                    data:  'action=goral_get_products&columns=' + main.data('columns') + '&product_type=' + main.data('product_type') + '&number=' + main.data('number')
...
jQuery( document).ready( function($){
    ...
    if ( main_sticky.length > 0 ){
        var _header_action_width = main_sticky.height();
        if (_header_action_width < 0) {
            _header_action_width = 0;
        }
