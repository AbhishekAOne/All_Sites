    ...
    <div class="row">
        ...
        <div class="col-md-<?php echo (has_post_thumbnail() ? '6' : '12'); ?>">
          <div class="info-content ">
            ...
            <?php } else { ?>
                <div class="description"><?php echo goral_substring( get_the_excerpt(), $nb_word, '...' ); ?></div>
            <?php } ?>

            <a class="btn btn-outline btn-theme" href="<?php the_permalink(); ?>"><?php esc_html_e('VIEW MORE','goral') ?></a>
          </div>
        </div>
    </div>
</article>